package code.algorithms.frequentpatterns.charm;
...
import code.patterns.itemset_array_integers_with_tids_bitset.Itemset;
import code.patterns.itemset_array_integers_with_tids_bitset.Itemsets;
...
loopJ:		for(int j=i+1; j < frequentItems.size(); j++) {
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		code.patterns.itemset_array_integers_with_count.Itemset itemset = new code.patterns.itemset_array_integers_with_count.Itemset(prefixSuffix);
